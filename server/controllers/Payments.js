...
exports.capturePayment = async (req, res) => {
  ...
  for (const course_id of courses) {
    ...
    try {
      ...
      course = await Course.findById(course_id).populate("studentsEnrolled");
  ...
  try {
    ...
    //   console.error("Razorpay instance or orders is undefined");
    //   return res.status(500).json({ 
    //     success: false, 
    //     message: "Razorpay not properly configured" 
    //   });
    // }
